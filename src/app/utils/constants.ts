...
export const ARROW_DOWM = {
  default: "/arrow-down-white.png",
  black: "/arrow-down-black.png",
};
...
export const CONTENT = {
  ...
  experiences: {
    ...
    desktop: {
      ...
      item4: "Web design that combines aesthetics with seamless functionality.",
  ...
  wheelsup: {
    day: "SEP 12, 2024",
    welcome: `Welcome<br>Wheels Up!`,
    subText: "Reimagining the future of flying private.",
  },
  dribbble: {
    title: "Follow us on dribbble",
    text: `We create and launch entire digital<br>ecosystems used by billions.`,
    button: "Dribbble",
    desktop: {
      title: "Follow us on<br>dribbble",
    },
  },
  blog: {
    title: "From our blog",
    ...
    newsTitle2: "Capturing Moments That Matter",
    newsBrief2:
      "See how our photography enhanced a client’s visual storytelling.",
